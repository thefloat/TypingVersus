...
public class ArenaClientFxmlController {
...
//		Server only
	...
	public void initialize() {
	    ...
	    bttLogic.handleJoinServer(bttLogic, bttTextEditorController.scrollPane, chatBp, statsBp, chatVB, statsVB, bttTextEditorController.textFlow, bttTextEditorController.textArea, 
	    		youPBar, oppPBar, timerLbl, youNameLbl, oppNameLbl, youNameStatsLbl, oppNameStatsLbl, youScoreTxt, oppScoreTxt, youWPMTxt, oppWPMTxt, 
	    		youWPMValTxt, oppWPMValTxt, youPointsTxt, oppPointsTxt, youWinLoseTxt, oppWinLoseTxt, arenaTxt, timerCDTxt);
	}  
}
